...
final class FavoritesListCharactersCell: UICollectionViewCell {
    
    // MARK: - Properties
    
    static let identifier: String = "FavoritesListCharactersCell"
...
extension FavoritesListCharactersCell: ViewCodeProtocol {
func setupElements() {
